...
public class PatchClass {
    ...
    public static void process(String buildDir, String lib) {
        ...
        CtClass c = classes.getCtClass("cn.tovi.andinupdate_dex.BugClass")
        if (c.isFrozen()) {
            c.defrost()
        }
        println("====添加构造方法====")
        def constructor = c.getConstructors()[0];
        constructor.insertBefore("System.out.println(cn.tovi.hackdex.AntilazyLoad.class);")
        c.writeFile(buildDir)



//        CtClass c1 = classes.getCtClass("cn.tovi.hotfix.LoadBugClass")
//        if (c1.isFrozen()) {
//            c1.defrost()
//        }
//        println("====添加构造方法====")
